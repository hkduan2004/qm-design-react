...
export class Editor extends React.Component<IAllProps> {
  ...
  private boundHandlers: Record<string, (event: any) => unknown>;
  private rollbackTimer: number | undefined = undefined;
  private valueCursor: any | undefined = undefined;
  ...
  private handleBeforeInput = (_evt: any) => {
  ...
  private handleBeforeInputSpecial = (evt: any) => {
    if (evt.key === 'Enter' || evt.key === 'Backspace' || evt.key === 'Delete') {
      this.handleBeforeInput(evt);
    }
  };

  private handleEditorChange = (_evt: any) => {
    const editor = this.editor;
  ...
  private handleEditorChangeSpecial = (evt: any) => {
